        ...
        children: [
          GoogleMap(
            initialCameraPosition: CameraPosition(
              // Muscat coordinates used ONLY as initial camera center, not as bus location
              target: tracking != null ? LatLng(tracking.lat, tracking.lng) : const LatLng(23.5880, 58.3829),
              zoom: 14,
            ),
            markers: {
              if (tracking != null)
            ...
            polylines: {
              if (tracking != null && tracking.polylinePoints.isNotEmpty)
                Polyline(
                  polylineId: const PolylineId('route'),
                  points: tracking.polylinePoints,
