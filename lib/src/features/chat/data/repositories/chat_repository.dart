...
class ChatRepository {
  ...
  Future<ChatConversation> startConversation(int receiverId) async {
    try {
      ...
      developer.log(
        '💬 ChatRepo: conversation started with user $receiverId',
        name: 'CHAT',
      );
      ...
      developer.log(
        '❌ ChatRepo.startConversation failed',
        name: 'CHAT',
        error: e,
        stackTrace: st,
      );
  ...
  Future<ChatMessage> sendMessage(
    ...
    try {
      ...
      developer.log(
        '💬 ChatRepo: message sent to conv $conversationId',
        name: 'CHAT',
      );
  ...
  Future<List<ChatMessage>> getMessages(int conversationId) async {
    try {
      ...
      developer.log(
        '💬 ChatRepo: got ${data.length} messages for conv $conversationId',
        name: 'CHAT',
      );
      return data
  ...
  Future<void> markAsRead(int conversationId) async {
    try {
      ...
      developer.log(
        '💬 ChatRepo: conv $conversationId marked as read',
        name: 'CHAT',
      );
    } catch (e, st) {
      developer.log(
        '❌ ChatRepo.markAsRead failed',
        name: 'CHAT',
        error: e,
        stackTrace: st,
      );
